...
#ifndef GNSS_SDR_GPS_L1_CA_DOUBLE_CHIP_RATE_TRACKING_H
#define GNSS_SDR_GPS_L1_CA_DOUBLE_CHIP_RATE_TRACKING_H
 ...
 */
class GpsL1CaDoubleChipRateTracking : public BaseDllPllTracking
{
public:
    //! Constructor
    GpsL1CaDoubleChipRateTracking(const ConfigurationInterface* configuration,

            ...
            if (d_signal_type == "1C")
                {
                    ...
                    // ==============================================================
                    // MAGIA LEO PNT: Toma el chip rate dinámicamente del adaptador
                    // y asigna la longitud del código correcta automáticamente.
                    // ==============================================================
                    if (d_trk_parameters.chip_rate > 0.0) {
                        ...
                        // Fallback original para GPS estándar
